...
// MARK: Category declaration for UITableView
@interface UITableView (BHTAdditions)
- (BOOL)BHT_isTargetViewController;
@end

// MARK: Hook for UITableView in SwiftUI hosting controller to remove first entry
%hook UITableView
...
- (BOOL)BHT_isTargetViewController {
    ...
    if (viewController) {
        ...
        return [vcClassName isEqualToString:@"_TtGC7SwiftUI19UIHostingControllerGV10TFNUISwift22HostingEnvironmentViewV11TwitterDash18DashNavigationView__"];
    }
    
    return NO;
}

// Filter visibleCells array
- (NSArray *)visibleCells {
    NSArray *originalCells = %orig;
    
    if ([self BHT_isTargetViewController] && originalCells.count > 1) {
...
// Filter indexPathsForVisibleRows array
- (NSArray *)indexPathsForVisibleRows {
    NSArray *originalIndexPaths = %orig;
    
    if ([self BHT_isTargetViewController] && originalIndexPaths.count > 1) {
...
// Filter tfn_visibleCells array (Twitter's custom property)
- (NSArray *)tfn_visibleCells {
    NSArray *originalCells = %orig;
...
// Filter tfn_indexPathsForVisibleCells array (Twitter's custom property)
- (NSArray *)tfn_indexPathsForVisibleCells {
    NSArray *originalIndexPaths = %orig;
