...
// T1ProfileSegmentedFollowingViewController interfaces for followers/following tab fix
...
@interface T1ProfileSegmentedFollowingViewController : UIViewController
@property(readonly, nonatomic) T1ProfileSegmentedFollowingViewControllerDataSource *retainedDataSource;
@property(readonly, nonatomic) id contentViewController; // TFNScrollingSegmentedViewController
